...
// ============================================================================
// TODO: Exercise 1 - Implement TagRepositoryImpl
// ============================================================================
//
...
class TagRepositoryImpl(
    ...
    override fun getAllTags(): Flow<List<Tag>> {
        TODO("Exercise 1: Implement getAllTags() - Use tagDao.getAllTags() and map to domain")
    }
    ...
    override suspend fun insertTag(tag: Tag): Long {
        TODO("Exercise 1: Implement insertTag() - Convert to entity and insert")
    }
    ...
    override suspend fun deleteTag(tag: Tag) {
        TODO("Exercise 1: Implement deleteTag() - Convert to entity and delete")
    }
    ...
    override suspend fun fetchRemoteTags(): Result<List<Tag>> {
        TODO("Exercise 1: Implement fetchRemoteTags() - Fetch from API and save to DB")
    }
}
